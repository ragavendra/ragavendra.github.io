...
I possess a total of about twelve years of work experience as a software engineer. My professional alignment is in QA with Automation (API and UI) or performance testing & tools development. 
    ...
    Rakefile task management for tests or specs run 

    Docker container management and environment setup 

    REST API SOA performance tests development using JMeter 

    MVC architecture third party stub development for Equifax, Fidelity & Red 
    ...
    Domains - Utilities, Media, Procurement, Healthcare, Finance, Networking 

 

Skills 

Programming Languages:		C#, Ruby, Java, Python, Javascript, Groovy, TCL/TK, Bash scripting, C, SQL 

Operating Systems: 		Linux , Windows, Mac, IBM UNIX/ AIX 

Databases:		MySQL, Oracle, MongoDB 

Packages:			Selenium, Vim with Tmux, Rakefile, Expect tool, Github, Docker, TestComplete, JMeter, QTP, Rational Functional Tester, Visual Studio, SOAP-UI, SAP – ISU[Text Wrapping Break] 

Professional Experience 

Translink 

Sr QA Automation Analyst			 						June 2019 – Current 
...
Implementing/ setting up framework for API automation testing. API tests for checking the API call response status, data and responses verification and integration testing. Machine learning generated data was tested for accuracy and validity, say for the bus arrival times at a particular bus stop. 
...
LinuxFlavour (my own proprietorship) 

Sr. Software Developer in Test - Mogo							June 2015 – Nov 2016 
...
[Text Wrapping Break]TestComplete automation framework and tests developer 

Test framework and tests were developed using the independent scripts to launch, load and run the tests developed in TestComplete and is scheduled to run on a daily runs. 
...
Description:[Text Wrapping Break]SAP-ISU test framework and tools development 
...
Automation Tester -  Standard & Poor							Jun 2009 – Dec 2009 
...
Bachelors in Computer Science Engineering							2000 – 2005 
...
Diploma in Embedded System Design in Linux							2006 

Centre for Development of Advanced Computing 

 

Capgemini Connects - Best Performer Award for BCHydro						2013 
